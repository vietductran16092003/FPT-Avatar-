...
function CampaignGrid({ campaigns }: { campaigns: Campaign[] }) {
  ...
  if (campaigns.length === 0) {
    return (
      <div className="mx-auto flex min-h-[60vh] max-w-xl flex-col items-center justify-center gap-2 p-6 text-center">
        <div className="text-lg font-bold">{t("heroTitle")}</div>
        <div className="text-muted-foreground">{t("noCampaignsTitle")}</div>
      </div>
    );
  }
  ...
  return (
    <div className="mx-auto max-w-5xl p-6">
      <div className="mb-6">
        ...
        <p className="mt-1 text-[14.5px] text-muted-foreground">{t("heroSubtitle")}</p>
      </div>
            ...
            <>
              ...
              <div className="flex flex-1 flex-col gap-1.5 p-5">
                ...
                <span
                  className={
                    notReady
                      ? "mt-2 inline-flex w-fit items-center gap-1.5 rounded-full bg-primary px-4 py-2 text-sm font-bold text-primary-foreground opacity-50"
                      : "mt-2 inline-flex w-fit items-center gap-1.5 rounded-full bg-primary px-4 py-2 text-sm font-bold text-primary-foreground transition-opacity group-hover:opacity-90"
                  }
                >
                  {ctaLabel}
                </span>
